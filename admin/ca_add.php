...
if (isset($_POST['save'])) {
    ...
    if (isset($_FILES['image']['name'])) {
        ...
        if ($image_name != "") {
            ...
            if ($upload == FALSE) {
                ...
                header("location:ca__update.php");
                die();
            }
        }
    }
    ...
    $sql = mysqli_query($conn, "INSERT INTO categories SET c_name='$name', c_image='$image_name';");
    if ($sql == TRUE) {
        header('location:category.php');
        $_SESSION['deleted'] = "<p class='text-success'>Category Added Successfully!</p>";
    } else {
        header('location:category.php');
        $_SESSION['e-deleted'] = "<p class='text-danger'>Error Adding Category!</p>";
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <section id="p-info">
        <h1 style="text-align: center;margin-top:3%">Add Category</h1>
        <!-- customer info -->
        <div class="infor">
