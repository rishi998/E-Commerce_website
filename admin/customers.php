...
<body>
    ...
    <section id="c-info">
        ...
        <div class="search">
            <form method="post">
                <input type="text" name="cus_name" placeholder="" required>
            ...
            <table style="width:80%;">
                ...
                <tbody class="text-center">
                    ...
                    if (isset($_POST['srch'])) {
                        ...
                        $sql = mysqli_query($conn, "SELECT * FROM users WHERE username='$username' OR full_name='$username'");
                    ...
                    ?> <tr>
                                    ...
                                    <td style="color:#a9a9ab;font-size:15px">* <?php echo $pass; ?> *</td>
                                    <td><?php echo $mail; ?></td>
                                    <td>
                                        <a href="c_d_v.php?id=<?php echo $id ?>" class="btn btn-danger btn-sm">Delete</a>
                                    </td>
                                    <?php $sno++; ?>
                            ...
                            <tr>
                                <td></td>
                                <td></td>
                                <td class="p-5 text-danger" style="font-weight:500">Customer Name: <?php echo $username; ?> : is Invalid!</td>
                                <td></td>
                                <td></td>
                            </tr><?php
                            ...
                            <tr>
                                <td></td>
                                <td></td>
                                <td class="p-5 text-danger" style="font-weight:500"> No Customer Found!</td>
                                <td></td>
                                <td></td>
                            </tr><?php
                                }
